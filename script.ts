...
const descriptionInput = document.getElementById('todo-desc') as HTMLTextAreaElement;
const actionButton = document.getElementById('add-btn') as HTMLButtonElement;
